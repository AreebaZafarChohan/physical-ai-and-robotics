...
const config = {
  ...
  tagline: 'Exploring the intersection of physical AI and humanoid robotics',
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/AreebaZafarChohan/physical-ai-and-robotics/tree/main/docs/',
        },
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Physical AI & Humanoid Robotics Platform. Built with Docusaurus.`,
      },
      prism: {
